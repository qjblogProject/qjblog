<template>
    <div class="header-wrap">
        ...
        <ul class='nav clearfix'>
            ...
            <li :class='{active:activeNav=="about"}'>关于我们</li>
        </ul>
    </div>
</template>
...
.header-wrap{
    ...
    .nav{
        ...
        li{
            ...
            cursor: pointer;
            padding: 0 20px;
            border-image: -webkit-linear-gradient(#d0d0d0, rgba(255,255,255,0)) 1 1;
